...
import com.koo.loomis.swiperecyclerview.touch.DefaultItemTouchHelper;
import com.koo.loomis.swiperecyclerview.touch.OnItemMoveListener;
import com.koo.loomis.swiperecyclerview.touch.OnItemMovementListener;
import com.koo.loomis.swiperecyclerview.touch.OnItemStateChangedListener;
import com.koo.loomis.swiperecyclerview.widget.DefaultLoadMoreView;
        ...
        if (allowSwipeDelete || !mSwipeItemMenuEnable || mSwipeMenuCreator == null) {
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN: {
                    ...
                    if (mDisableSwipeItemMenuList.contains(touchingPosition)) {
                        break;
                    }
